...
class PrayerTimesAPI {
    ...
    async fetchPrayerTimes(city = this.defaultCity) {
        try {
            ...
            // Get current calculation method and Asr method
            const method = document.getElementById('calculation-method')?.value || this.calculationMethod;
            const asrMethod = document.getElementById('asr-hanafi')?.checked ? 'hanafi' : 'standard';
