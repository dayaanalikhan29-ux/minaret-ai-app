                ...
                <style>
                    *, *::before, *::after { box-sizing: border-box; }
                    ...
                    body::before {
                        content: '';
                        position: fixed;
                        top: 120px; left: 0; width: 100vw; height: calc(100vh - 120px);
                        z-index: 0;
                        pointer-events: none;
                        opacity: 0.07;
                        background: url('data:image/svg+xml;utf8,<svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="0.18"><path d="M60 0L65.45 18.09H84.85L69.7 29.27L75.15 47.36L60 36.18L44.85 47.36L50.3 29.27L35.15 18.09H54.55L60 0Z" fill="%23c3a545"/></g></svg>');
                ...
                async function sendMessage(text) {
                    ...
                    try {
                        ...
                        let aiReply = '';
                            ...
                            if (messageContent) aiReply = messageContent.innerHTML;
                        }
                        if (!aiReply) {
                            const span = tempDiv.querySelector('.message-content');
                            aiReply = span ? span.innerHTML : '';
                        }
                        aiReply = aiReply.replace(/Source:.*$/i, '').replace(/OpenAI/gi, '').trim();
                        const now = new Date();
                        addMessage(aiReply, 'ai', now.toLocaleTimeString());
